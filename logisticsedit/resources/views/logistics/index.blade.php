			...
			<div class="card card-flush">
				...
				<div class="card-header align-items-center py-5 gap-2 gap-md-5">
					...
					<div class="card-title">
						...
						<a href="{{ url('/logistics/create') }}" class="btn btn-light-primary">
						Add Shipment</a>
						<!--end::Export dropdown-->
					</div>
					<!--end::Card toolbar-->
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5">
						...
						<tbody class="fw-semibold text-gray-600">
							...
							<tr>
								...
								<!--begin::No orders=-->
								<td>
									<form action="{{ route('logistics.destroy',$ship->shp_id) }}" method="Post">
									<a class="btn btn-primary" href="{{ route('logistics.edit',$ship->shp_id) }}">Edit</a>
									@csrf
									@method('DELETE')
