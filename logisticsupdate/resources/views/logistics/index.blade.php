			...
			<div class="card card-flush">
				...
				<div class="card-header align-items-center py-5 gap-2 gap-md-5">
					...
					<div class="card-title">
						...
						<a href="{{route('logistics.create')}}" class="btn btn-light-primary">
						Add Shipment</a>
						<!--end::Export dropdown-->
					</div>
					<!--end::Card toolbar-->
					...
					<table class="table align-middle table-row-dashed fs-6 gy-5">
						...
						<tbody class="fw-semibold text-gray-600">
							...
							<tr>
								...
								<td>
									<!--begin::Badges-->
									@if($ship->shp_status == 1)
										<div class="badge badge-light-warning">Pending</div>
									@elseif($ship->shp_status == 2)
										<div class="badge badge-light-primary">Packed</div>
									@elseif($ship->shp_status == 3)
								...
								<!--end::Status=-->
								<!--begin::No orders=-->
								<td><a href="{{ url('/logistics/' . $ship->shp_id . '/edit') }}" title="Edit Shipment"><button class="btn btn-primary btn-sm">Edit</button></a>
								<!--end::No orders=-->
								<form method="POST" action="{{ url('/logistics' . '/' . $ship->shp_id) }}" accept-charset="UTF-8" style="display:inline">
									{{ method_field('DELETE') }}
									{{ csrf_field() }}
									<button type="submit" class="btn btn-danger btn-sm" title="Delete Shipment" onclick="return confirm(&quot;Confirm delete?&quot;)"> Delete</button>
								</form>
							</td>
							</tr>
							@endforeach
