...
<html class="loading" lang="en" data-textdirection="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="../../../app-assets/css/pages/page-maintenance.css">
    <!-- END: Page Level CSS-->
    <!-- BEGIN: Custom CSS-->
  ...
  <div class="row">
    ...
    <div id="maintenance" class="col s12 center-align white">
      <img src="../../../app-assets/images/gallery/maintenance.png" class="responsive-img maintenance-img" alt="">
